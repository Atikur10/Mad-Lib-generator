...
Label(root, text='Mad Lib Generator', font='arial 20 bold').pack()
...
Button(root, text='The Photographer', font='arial 15 bold', command=madlib1, bg='ghost white').place(x=40,y=100)
Button(root,text='Butterfly',font='arial 15 bold', command=madlib2, bg = 'ghost white').place(x=40,y=160)
Button(root,text='Apple confusion', font='arial 15 bold', command=madlib3, bg='ghost white').place(x=40,y=220)
